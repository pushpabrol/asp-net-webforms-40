    ...
    public class Auth0Client
    {
        ...
        public UserProfile GetUserInfo(TokenResult tokenResult)
        {
            ...
            UserProfile userProfileFromJson = null;
                ...
                else userProfileFromJson = this.GetUserProfileFromJson(this.GetJsonProfileFromIdToken(tokenResult.IdToken));
        ...
        {
            string[] ignoredProperties = new string[4]
            {
        "iss",
        "aud",
        "exp",
        "iat"
            ...
            string[] mappedProperties = new string[8]
            {
        "email",
        "family_name",
        "given_name",
